...
{
    public partial class UpdateItemPage : Page
    {
        ...
        private void RenderInventoryItem(Item inventoryItem)
        {
            ...
            IsDeletedCheckbox.Checked = inventoryItem.IsDeleted;
        }
        ...
        private Boolean SaveItem(Item inventoryItem)
        {
            ...
            inventoryItem.IsDeleted = IsDeletedCheckbox.Checked;
            var confirmation = abcHardware.UpdateItem(inventoryItem);
            return confirmation;
        }
        ...
        private void DisplayResult(Boolean confirmation, Item inventoryItem)
        {
            if (confirmation)
            {
                ...
                MessageResult.Text = String.Format("Item [{0} - {1}] successfully updated.",
                                        ItemCode,
