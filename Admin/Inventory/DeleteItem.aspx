<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DeleteItem.aspx.cs" Inherits="Admin.Inventory.DeleteItemPage" %>
    ...
    <div runat="server" id="CustomerFieldsDiv" visible="false">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="DescriptionTextBox" Width="230px" MaxLength="40" ReadOnly="True" />&nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="UnitPriceTextBox" Width="230px" MaxLength="10" ReadOnly="True" />&nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="StockTextBox" Width="230px" MaxLength="20" ReadOnly="True" />&nbsp;
