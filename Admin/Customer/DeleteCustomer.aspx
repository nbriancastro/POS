<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DeleteCustomer.aspx.cs" Inherits="Admin.Customer.DeleteCustomerPage" %>
    ...
    <div runat="server" id="CustomerFieldsDiv" visible="false">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="CustomerNameTextBox" Width="230px" MaxLength="30" ReadOnly="true" />&nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="AddressTextBox" Width="230px" MaxLength="40" ReadOnly="true" />&nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="CityTextBox" Width="230px" MaxLength="20" ReadOnly="true" />&nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="ProvinceTextBox" Width="230px" MaxLength="20" ReadOnly="true" />&nbsp;
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="PostalTextBox" Width="230px" MaxLength="7" ReadOnly="true" />&nbsp;
        ...
        <br />
        <asp:Button runat="server" ID="DeleteButton" Text="Delete" Width="80px" OnClick="DeleteButton_Click" />&nbsp;
